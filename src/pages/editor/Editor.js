...
import { getUnitPoints, getPoints, getAllPoints, getCorePointsForMinimum } from "../../utils/points";
...
export const Editor = ({ isMobile }) => {
  ...
  const corePointsForMinimum = getCorePointsForMinimum(list);
